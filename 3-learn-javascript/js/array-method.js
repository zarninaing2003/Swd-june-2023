...
// console.log(points.includes(20));
// console.log(points.indexOf(15));
// console.log(points.indexOf(56));

const animals = ['ant', 'bison', 'camel', 'duck', 'duck','elephant']
// console.log(animals);
...
// console.log("ည".charCodeAt());
// console.log("င".charCodeAt());
...
// console.table(products.filter(el => el.price < 50));
// console.table(products.find(el => el.price < 50));
...
// console.log(products.some(el => el.id===5));
// console.log(products.every(el => el.id===5));
// console.log(products.every(el => el.price < 500));
...
// price <50 kon pyit si tay yaet su su pone tan phone
